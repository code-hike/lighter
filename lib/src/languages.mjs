...
// generated with `node utils/deps-by-id.mjs`
export const idDepsById = {
  apl: ["java", "json", "javascript", "css", "xml", "html"],
  astro: [
    "stylus",
    "scss",
    "sass",
  ...
  blade: ["java", "css", "json", "javascript", "sql", "xml", "html"],
  cobol: ["css", "javascript", "java", "html", "sql"],
  codeql: [
    "gnuplot",
    "haskell",
    "tex",
  ...
  glsl: ["c"],
  graphql: ["tsx", "jsx", "typescript", "javascript"],
  hack: ["css", "javascript", "sql", "html"],
  haml: [
    "gnuplot",
    "haskell",
    "tex",
  ...
  handlebars: ["yaml", "javascript", "css", "html"],
  html: ["css", "javascript"],
  "jinja-html": ["css", "javascript", "html"],
  julia: ["c", "glsl", "sql", "r", "javascript", "python", "cpp"],
  latex: [
    "stylus",
    "sass",
    "bibtex",
  ...
  less: ["css"],
  liquid: ["javascript", "json", "css", "html"],
  lua: ["c"],
  markdown: [
    "gnuplot",
    "haskell",
  ...
  marko: ["typescript", "scss", "less", "css"],
  mdx: [
    "gnuplot",
    "haskell",
    "tex",
  ...
  perl: ["java", "sql", "javascript", "css", "xml", "html"],
  php: ["java", "css", "json", "javascript", "sql", "xml", "html"],
  pug: ["html", "coffee", "stylus", "sass", "css", "javascript"],
  razor: ["css", "javascript", "csharp", "html"],
  rst: [
    "gnuplot",
    "haskell",
    "tex",
